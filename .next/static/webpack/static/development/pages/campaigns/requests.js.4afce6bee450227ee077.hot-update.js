...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(RequestRow, [{
    ...
    value: function render() {
      ...
      }, __jsx(Cell, null, id), __jsx(Cell, null, request.description), __jsx(Cell, null, _ethereum_web3__WEBPACK_IMPORTED_MODULE_11__["default"].utils.fromWei(request.value, 'ether')), __jsx(Cell, null, request.recepient), __jsx(Cell, null, "".concat(request.approvalCount, "/").concat(approversCount)), __jsx(Cell, null, request.complete ? null : __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        basic: true,
        color: "green",
...
//# sourceMappingURL=requests.js.4afce6bee450227ee077.hot-update.js.map