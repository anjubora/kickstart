...
function (_Component) {
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 7:
                next_router__WEBPACK_IMPORTED_MODULE_13__["Router"].pushRoute("/campaigns/".concat(address, "/requests"));
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(RequestRow, [{
    ...
    value: function render() {
      ...
      }, __jsx(Cell, null, id), __jsx(Cell, null, request.description), __jsx(Cell, null, request.description), __jsx(Cell, null, _ethereum_web3__WEBPACK_IMPORTED_MODULE_11__["default"].utils.fromWei(request.value, 'ether')), __jsx(Cell, null, "".concat(request.approvalCount, "/").concat(approversCount)), __jsx(Cell, null, request.complete ? null : __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        basic: true,
        color: "green",
        onClick: this.onApprove
      }, "Approve")), __jsx(Cell, null, request.complete ? null : __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_10__["Button"], {
        basic: true,
        color: "pink",
...
//# sourceMappingURL=requests.js.c81ec30b329d22f87015.hot-update.js.map